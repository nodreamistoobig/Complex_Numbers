...
int main()
{
	...
	if (D > 0) {
		...
		cout << "Комплексное в степени комплексного "<< x1.Power(x2)<<endl;
		cout << "Вещественное в степени вещественного, но с использованием алгоритма возведения комплексногоо в комплексное "<< a.Power(b)<<endl;
	}
}
